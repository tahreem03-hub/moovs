...
const Sidebar = () => {
    ...
    return (
        <div className="fixed top-18 left-0 w-50 sm:w-25 h-[calc(100vh-72px)] overflow-y-auto bg-white border-r border-gray-300 ">
            ...
            ${isActive ? "bg-sky-200/50 text-blue-600" : "text-gray-800 hover:bg-sky-200/30"}`
                ...
                <div className='h-15 rounded flex sm:flex-col items-center sm:justify-center max-sm:mb-0.5 max-sm:pl-2 max-sm:h-11 transition  text-gray-800 hover:bg-sky-200/30'>
